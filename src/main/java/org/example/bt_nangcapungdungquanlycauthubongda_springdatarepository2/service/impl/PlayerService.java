...
import org.example.bt_nangcapungdungquanlycauthubongda_springdatarepository2.repository.IPlayerRepo;
...
//        }
//    }
    public Page<Player> getPlayer( int page, int size,String name, Date dobMin, Date dobMax) {
        if (size==0){
            size=5;
        }
